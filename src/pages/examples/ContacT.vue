          ...
          <q-tab-panels v-model="tab" animated class="bg-white">
            <q-tab-panel name="all" class="q-pa-none full-height" :style="{'height':size['height']-80+'px !important'}">
              <q-list class="">
                ...
                <q-item-label header class="text-center">{{ contactsList.length }} CONTACTS</q-item-label>


                <span v-for="(contact, index) in contactsList" :key="index" @click="selectedContact=contact">
                  <contact-item
            ...
            <q-tab-panel name="favorites" class="q-pa-none" :style="{'height':size['height']-80+'px !important'}">
              <q-list class="">
                ...
                <q-item-label header class="text-center">{{ favoritesList.length }} Favorites</q-item-label>

                <span v-for="(favorite, index) in favoritesList" :key="index" @click="selectedContact=favorite">
                  <contact-item
        ...
        <q-card class="no-border no-border" :style="{'height':size['height']-24+'px !important'}">
          <q-toolbar class="text-black ">
            ...
            <q-item class="q-subtitle-1 q-pl-md">
              <q-item-section>
                <q-item-label lines="1">{{ selectedContact.name }}</q-item-label>
                <q-item-label caption lines="2">
                  <span class="text-weight-bold">{{ selectedContact.position }}</span>
                </q-item-label>
              </q-item-section>
            </q-item>
          ...
          <div v-for="(detail, detailIndex) in detailList" :key="detailIndex">
            ...
            <contact-detail-item :icon="detail.icon" :text_color="detail.text_color"
                                 :value="selectedContact[detail['field']]" :label="detail.label"></contact-detail-item>
      ...
      >
        <q-card class="no-border no-border"
          ...
          <q-toolbar class="text-black ">
            ...
            <q-btn round flat icon="edit"/>
            <q-btn round flat icon="keyboard_backspace" @click="selectedContact={}"/>
