...
const messages = [
  {
    id: 5,
    name: 'Pratik Patel',
    msg: 'd. Do you want to grab brunch?',
  ...
  },
  {
    ...
    msg: ' Ill be in your neighborhood doing errands this\n' + '            weekend. Do you want to grab brunch?',
...
const salesData = [
  ...
  },
  {
    ...
    total: '$230,00',
    code: 'ABC890',
    prod_img: 'src/assets/laptop.jpg'
  },
  {
    name: 'Mayur Patel',
    Progress: 30,
  ...
  },
  {
    ...
    date: '19 Sept 2020',
    code: 'JKL345',
    prod_img: 'src/assets/action.jpg'
  }
]
const salesColumn = [
  {
...
export default defineComponent({
  ...
  methods: {
    init () {
      ...
      /* this.sales_chart.setOption(this.salesOptions)
